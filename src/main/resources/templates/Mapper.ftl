...
<mapper namespace="${dao}.${name}Mapper">

    <resultMap id="${table_name}ResultMap" type="${package_name}.dto.${table_name}DTO">
    ...
    <select id="findDTOById" parameterType="String" resultMap="${table_name}ResultMap">
